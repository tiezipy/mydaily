...
<div class="main-content">
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="给日志想个名字" name="title"   class="col-xs-10 col-sm-5" /></div>
                        </div>

                        <div class="form-group">
                                <label for="form-field-select-1" class="col-sm-3 control-label no-padding-right">类别</label>
                                <div class="col-sm-6">
                                    <select class="form-control" id="form-field-select-1" name="kindid">
                                        <?php if(is_array($kinds)): $i = 0; $__LIST__ = $kinds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["kindname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
    ...
    <script type="text/javascript" src="/mydaily/Public/Admin/assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="/mydaily/Public/Admin/assets/js/wangEditor.min.js"></script>
    <script type="text/javascript">
        ...
        document.getElementById('submit').addEventListener('click', function () {
            ...
            var kindid=$("#form-field-select-1").val();
            var content=editor.txt.text();

            var url= 'http://localhost/mydaily/Admin/Daily/insert';
            $.ajax({
                type:'post',
                url:url,
                data:{title:title,kindid:kindid,content:content},
                success:function (data) {
                    alert(data);
                    location.href="http://localhost/mydaily/Admin/Daily/index";
                }
