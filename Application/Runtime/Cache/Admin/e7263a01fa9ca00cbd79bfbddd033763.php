                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php if(is_array($kinds)): $i = 0; $__LIST__ = $kinds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="<?php echo U('Kind/delete',array('id'=>$vo['id']));?>">
