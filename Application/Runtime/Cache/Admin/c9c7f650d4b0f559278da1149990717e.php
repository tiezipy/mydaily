								...
								<div class="row">
									<div class="col-xs-12">
										<table id="sample-table-1" class="table table-striped table-bordered table-hover">
											...
											<?php if(is_array($dailys)): $i = 0; $__LIST__ = $dailys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															<a href="<?php echo U('Daily/edit',array('id'=>$vo['id']));?>">
																<button class="btn btn-xs btn-info">
																	<i class="ace-icon fa fa-pencil bigger-120"></i>
																</button>
															</a>
															<a href="<?php echo U('Daily/delete',array('id'=>$vo['id']));?>">
