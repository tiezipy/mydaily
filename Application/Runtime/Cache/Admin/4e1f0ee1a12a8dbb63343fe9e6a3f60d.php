...
<div class="main-content">
    <div class="page-content-area">
        <div class="page-content">
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" method="post" action="/mydaily/index.php/Admin/User/insert">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="col-sm-7">
                                <input name="username" class="input-sm" type="text"  placeholder="请输入新增用户名" />
                                <input name="password" class="input-sm" type="text"  placeholder="请输入密码" />
                            </div>
