...
<div class="main-content">
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" value="<?php echo ($res[0]["title"]); ?>" name="title"   class="col-xs-10 col-sm-5" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id='kindid' value="<?php echo ($res[0]["kindid"]); ?>">
                            <input type="hidden" id='dailysid' value="<?php echo ($res[0]["id"]); ?>">
                            <div class="col-sm-6">
                                <?php echo ($res[0]["kindname"]); ?>
                            </div>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('update').addEventListener('click', function () {
            ...
            var url= 'http://localhost/mydaily/Admin/Daily/update';
            $.ajax({
                type:'post',
                url:url,
