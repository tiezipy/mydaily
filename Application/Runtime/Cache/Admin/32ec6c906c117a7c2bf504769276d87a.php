...
<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="/mydaily/Public/Admin/assets/css/ace.min.css" />
    ...
    <!--[if lt IE 9]>
    <script src="/mydaily/Public/Admin/assets/js/html5shiv.js"></script>
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="white" id="id-text2">MYDAILY</span>
                        </h1>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form method="post" action="/mydaily/index.php/Admin/Login/login">                                        <fieldset>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='/mydaily/Public/Admin/assets/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
<script type="text/javascript">
