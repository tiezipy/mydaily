...
<div class="main-content">
    <div class="page-content-area">
        <div class="page-content">
            <div class="col-xs-12">
            <form class="form-horizontal" role="form" method="post" action="/mydaily/index.php/Admin/Kind/insert">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-4">分类名称</label>

                    <div class="col-sm-9">
                        <input name="kindname" class="input-sm" type="text" id="form-field-4" placeholder="请输入新增分类名称" />
                ...
                <!--<form action="/mydaily/index.php/Admin/Kind/insert" method="post">-->
